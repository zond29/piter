...
st.markdown("""
    <style>
        /* Скрываем только конкретные кнопки в меню */
        button[aria-label="Share"], 
        button[aria-label="Star this repo"], 
        a[href*="github.com"] {
            display: none !important;
        }
        /* Скрываем футер и лого Streamlit */
        ...
        .place-card {background: var(--background-color); border: 1px solid var(--secondary-background-color); border-radius: 16px; padding: 20px; margin-bottom: 20px; box-shadow: 0 4px 20px rgba(0,0,0,0.05);}
